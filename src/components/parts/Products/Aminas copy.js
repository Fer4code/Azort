...
import { petanolamina } from '../Products';
...
export default function ResponsiveDialog() {
  ...
  const aliconst = (
    ...
    Es un compuesto químico orgánico que es tanto una amina primaria, como un alcohol primario. Se utiliza para 
    fabricar jabón y detergentes, tinta, caucho.
